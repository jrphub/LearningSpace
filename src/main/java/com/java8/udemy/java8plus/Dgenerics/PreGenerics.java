package com.java8.udemy.java8plus.Dgenerics;

import com.java8.udemy.java8plus.Dgenerics.beans.Dog;
...
public class PreGenerics {
    public static void main(String []args) {
		...
		System.out.println("element present : " + s);
		...
		//The problem is only Object's methods are available i.e. all type information is removed from byte code. This is called type erasure.
